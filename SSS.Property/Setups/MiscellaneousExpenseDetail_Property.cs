...
{
    public class MiscellaneousExpenseDetail_Property
    {
        #region Class Member Declarations
        private SqlDateTime _expenseDate, _transactionDate, _insertionDate, _updationDate;
        private SqlDecimal _expenseAmount;
        private SqlInt32 _claimStatus, _updateBy, _insertBy, _dataRefId, _miscellaneousSetupId, _distributorId, _id;
        ...
        public SqlInt32 MiscellaneousSetupId
        {
            get
            {
                return _miscellaneousSetupId;
            }
            set
            {
                _miscellaneousSetupId = value;
            }
        }
