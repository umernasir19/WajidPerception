...
{
    public class Transaction_Master_Property
    {
        ...
        private SqlString _transaction_Master_fld1, _transaction_Master_fld2, _transaction_Master_fld3, _flag, _status, _Functionality_Enum, _ref_Document, _ref_Document1, _payment_Terms, _document_No, _record_Table_Name, operation, _narration, _sortColumn, _tableName, _distributorIdList;
        private DataTable _detailData, _ConfigdetailData;

        private string _detailDataStr;
        private string _reportType;

        private SqlInt32? _document_Type_ID, _distributor_ID2, _location_ID, _distributor_ID;
        private int? _TotalRowsNum;
        private string _tempID, _cashMemoXml;
        #endregion
        ...
        public SqlString DistributorIdList
        {
            get
            {
                return _distributorIdList;
            }
            set
            {
                _distributorIdList = value;
            }
        }

        public SqlString Transaction_Master_fld1
        {
            get
            {
                return _transaction_Master_fld1;
            }
            set
            {
                _transaction_Master_fld1 = value;
            }
        }

        public SqlString Transaction_Master_fld2
        {
            get
            {
                return _transaction_Master_fld2;
            }
            set
            {
                _transaction_Master_fld2 = value;
            }
        }

        public SqlString Transaction_Master_fld3
        {
            get
            {
                return _transaction_Master_fld3;
            }
            set
            {
                _transaction_Master_fld3 = value;
            }
        }
        ...
        public String DetailDataStr
        {
            get
            {
                return _detailDataStr;
            }
            set
            {
                _detailDataStr = value;
            }
        }

        public DataTable ConfigDetailData
        {
            get
            {
                return _ConfigdetailData;
            }
            set
            {
                _ConfigdetailData = value;
            }
        }
        ///// Extra Properties
