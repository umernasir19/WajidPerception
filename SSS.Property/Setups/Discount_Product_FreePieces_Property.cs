...
{
    public class Discount_Product_FreePieces_Property
    {
        //#region Class Member Declarations
        //private SqlInt32 _free_Product_ID, _product_ID, _iD, _discount_ID, _discount_IDOld;
        ...
        public int? Discount_IDOld { get; set; }
        public int? Product_ID { get; set; }
        public int? Free_Product_ID { get; set; }
        public int? Alternate_Product_ID { get; set; }
        public string Narration { get; set; }
        public string Status { get; set; }
        public DateTime? Operation_Date { get; set; }
        public string Operation { get; set; }
        public int? Operated_By { get; set; }
        public string Record_Table_Name { get; set; }
        ...
        //public int?  Alternate_Product_ID { get; set; }
        ////public int Alternate_Product_ID
        ////{
        ////    get
        ////    {
