...
{
    public class StockAdjustmentOutMaster_DAL : DBInteractionBase
    {
        private StockAdjustmentOutMaster_Property objStockAdjOutProperty;
        private ErrorTracer objErrorTrace;

        public StockAdjustmentOutMaster_DAL()
        {
        }

        public StockAdjustmentOutMaster_DAL(StockAdjustmentOutMaster_Property objStockAdjOut_Property)
        {
        ...
        public override bool Insert()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@id", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, objStockAdjOutProperty.ID));
                ...
                objStockAdjOutProperty.ID = (int)cmdToExecute.Parameters["@id"].Value;
