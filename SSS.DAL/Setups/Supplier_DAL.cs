...
{
    public class Supplier_DAL: DBInteractionBase
    {
        private Suppliers_Property ObjsupplierProperty;
        ...
        public DataTable ViewMaxSupplierCode()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_Supplier_Setup_Select_Max_Supplier_Code]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("SUPPLIER_SETUP");
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Customer_SETUP::SelectAll::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
        ...
        public Supplier_DAL(Suppliers_Property Objsupplier_Property)
        {
            ObjsupplierProperty = Objsupplier_Property;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_supplier_Insert]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@CustomerName", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierName));
                cmdToExecute.Parameters.Add(new SqlParameter("@Address", SqlDbType.NVarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierAddress));
                cmdToExecute.Parameters.Add(new SqlParameter("@phoneno", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierPhone));
                cmdToExecute.Parameters.Add(new SqlParameter("@MobileNo", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierMobile));
                cmdToExecute.Parameters.Add(new SqlParameter("@email", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierEmail));
                cmdToExecute.Parameters.Add(new SqlParameter("@datecreated", SqlDbType.NVarChar, 100, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.CreatedDate));
                cmdToExecute.Parameters.Add(new SqlParameter("@status", SqlDbType.NVarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@isactice", SqlDbType.Bit, 4, ParameterDirection.Input, false, 1, 1, "", DataRowVersion.Proposed, ObjsupplierProperty.ISActive));
                cmdToExecute.Parameters.Add(new SqlParameter("@userid", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.UserId));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_GetAllSuppliers]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Supplier_SETUP");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_Suppliers_SETUP_SelectOne]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Supplier_SETUP");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.Supplier_Id));
                ...
                {
                    ObjsupplierProperty.Supplier_Id = (Int32)toReturn.Rows[0]["ID"];
                    ObjsupplierProperty.SupplierName = (string)toReturn.Rows[0]["Name"];
                    //toReturn.Rows[0]["Product_Type_ID"] == System.DBNull.Value ? SqlInt32.Null : (Int32)toReturn.Rows[0]["Product_Type_ID"];
                    ObjsupplierProperty.SuppliersCode = (string)toReturn.Rows[0]["Code"];
                    //toReturn.Rows[0]["Packing_Unit_ID"] == System.DBNull.Value ? SqlInt32.Null : (Int32)toReturn.Rows[0]["Packing_Unit_ID"];
                    ObjsupplierProperty.SupplierMobile = (string)toReturn.Rows[0]["Mobile_No"];
                    //toReturn.Rows[0]["Product_Form_ID"] == System.DBNull.Value ? SqlInt32.Null : (Int32)toReturn.Rows[0]["Product_Form_ID"];
                    ObjsupplierProperty.SupplierPhone = (string)toReturn.Rows[0]["Phone_No"];
                    //toReturn.Rows[0]["Product_Code"] == System.DBNull.Value ? SqlString.Null : (string)toReturn.Rows[0]["Product_Code"];
                    ObjsupplierProperty.SupplierEmail = (string)toReturn.Rows[0]["Email"];
                    ObjsupplierProperty.SupplierAddress = (string)toReturn.Rows[0]["Address"];
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_Suppliers_SETUP_Update]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.Supplier_Id));
                cmdToExecute.Parameters.Add(new SqlParameter("@customer_Name", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierName));
                cmdToExecute.Parameters.Add(new SqlParameter("@Address", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierAddress));
                cmdToExecute.Parameters.Add(new SqlParameter("@Phone_No", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierPhone));
                cmdToExecute.Parameters.Add(new SqlParameter("@Mobile_No", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierMobile));
                cmdToExecute.Parameters.Add(new SqlParameter("@Email", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.SupplierEmail));
                cmdToExecute.Parameters.Add(new SqlParameter("@User_id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.UserId));
        ...
        public bool UpdateStatus()
        {
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@tableName", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.TableName));
                cmdToExecute.Parameters.Add(new SqlParameter("@recordId", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.Supplier_Id));
                cmdToExecute.Parameters.Add(new SqlParameter("@operation", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@operationBy", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjsupplierProperty.Operated_By));
