...
{
   public class Department_DAL: DBInteractionBase
    {
        private Department_Setup_Property ObjDepartmentProperty;
        ...
        public Department_DAL(Department_Setup_Property ObjDepartmentSetup_Property)
        {
            ObjDepartmentProperty = ObjDepartmentSetup_Property;
        ...
        public override bool Insert()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_InsertToDepartment]";
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@name", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.DepartmentName));
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@isactive", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.ISActive));
                cmdToExecute.Parameters.Add(new SqlParameter("@datecreated", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.CreatedDate));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_checkDepartments]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@value", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed,ObjDepartmentProperty.DepartmentName));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_GetAllDepartments]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_Department_SETUP_SelectOne]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Department_SETUP");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.Department_Id));
                ...
                if (toReturn.Rows.Count > 0)
                {
                    ...
                    ObjDepartmentProperty.Status = (string)toReturn.Rows[0]["Status"];
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_Department_SETUP_Update]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.Department_Id));
                cmdToExecute.Parameters.Add(new SqlParameter("@name", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.DepartmentName));
                cmdToExecute.Parameters.Add(new SqlParameter("@status", SqlDbType.NVarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.Status));
        ...
        public bool UpdateStatus()
        {
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@tableName", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.TableName));
                cmdToExecute.Parameters.Add(new SqlParameter("@recordId", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.Department_Id));
                cmdToExecute.Parameters.Add(new SqlParameter("@operation", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@operationBy", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, ObjDepartmentProperty.Operated_By));
