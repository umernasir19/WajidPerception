...
{
   public class CompanyBank_DAL:DBInteractionBase
    {
        CompanyBank_Property objCompanyBankProperty;

        public CompanyBank_DAL()
        {

        }
        public CompanyBank_DAL(CompanyBank_Property objCompanyBank)
        {
            objCompanyBankProperty = objCompanyBank;
        }
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_CompanyBankGetALL]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"sp_DeleteCompanyBank";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
