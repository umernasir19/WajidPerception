...
{
    public class Discount_Master_DAL : DBInteractionBase
       
    {
        private Discount_Master_Property objDiscountMasterProperty;

        public Discount_Master_DAL(Discount_Master_Property objTransaction_Master_Property)
        {
            objDiscountMasterProperty = objTransaction_Master_Property;
        }
        ...
        public override bool Insert()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_DISCOUNT_MASTER_Insert]";
            ...
            try
            {
                ...
                //  cmdToExecute.Parameters.Add(new SqlParameter("@iDiscount_Code", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Discount_Code));
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@sStatus", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.ID));
                ...
                if (objDiscountMasterProperty.DetailData != null)
                {

                    foreach (DataRow row in objDiscountMasterProperty.DetailData.Rows)
                    {

                        row["Transaction_Id"] = cmdToExecute.Parameters["@iID"].Value.ToString();
                    }

                    objDiscountMasterProperty.DetailData.AcceptChanges();

                    SqlBulkCopy sbc = new SqlBulkCopy(_mainConnection, SqlBulkCopyOptions.Default, this.Transaction);
                    objDiscountMasterProperty.DetailData.TableName = "DISCOUNT_SLABS_SETUP";

                    sbc.ColumnMappings.Clear();
                    sbc.ColumnMappings.Add(2, 1);
                    sbc.ColumnMappings.Add(8, 2);
                    sbc.ColumnMappings.Add(9, 3);
                    sbc.ColumnMappings.Add(5, 4);
                    sbc.ColumnMappings.Add(7, 5);
                    sbc.ColumnMappings.Add(6, 6);
                    sbc.ColumnMappings.Add(3, 7);
                    sbc.ColumnMappings.Add(4, 8);
                    sbc.ColumnMappings.Add(10, 9);

                    sbc.DestinationTableName = objDiscountMasterProperty.DetailData.TableName;
                    sbc.WriteToServer(objDiscountMasterProperty.DetailData);
                ...
                if (_errorCode != (int)LLBLError.AllOk)
                {
                    this.RollBack();
                    // Throw error.
                    throw new Exception("Stored Procedure 'sp_DISCOUNT_MASTER_Insert' reported the ErrorCode: " + _errorCode);
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("DISCOUNT_MASTER::Insert::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
        ...
        public bool UpdateStatus()
        {
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@tableName", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.TableName));
                cmdToExecute.Parameters.Add(new SqlParameter("@recordId", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@operation", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@operationBy", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Operated_By));
        ...
        public DataSet SelectAllByID()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_DISCOUNTMASTER_DICOUNTSLAB_SELECTALL_BY_DISCOUNTID]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataSet toReturn = new DataSet("DISCOUNT_MASTER");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@DISCOUNT_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@distributorId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.SNo));
                // cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, _errorCode));
        ...
        //    {
        //        cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.ID));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@sBatch_Code", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Batch_Code));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@sDescription", SqlDbType.VarChar, 200, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Description));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@sActive_Status", SqlDbType.VarChar, 1, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Active_Status));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@iProduct_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Product_ID));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@iPrice_ID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Price_ID));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@iBatch_Index", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Batch_Index));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@daBatch_Date", SqlDbType.DateTime, 8, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Batch_Date));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@daExpire_Date", SqlDbType.DateTime, 8, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Expire_Date));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@iSale_Alert_Days", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Sale_Alert_Days));
        //        cmdToExecute.Parameters.Add(new SqlParameter("@iSale_Stop_Days", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Sale_Stop_Days));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_SelectCurrent_TradeOffer]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("DISCOUNT_MASTER");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_SelectPrivious_TradeOffer]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("DISCOUNT_MASTER");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
        ...
        public DataTable SelectDistributor_TradeOffer(int CircularID)
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_SelectDistributor_TradeOffer]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("DISCOUNT_MASTER");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                   cmdToExecute.Parameters.Add(new SqlParameter("@DistributorID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, CircularID));
                   cmdToExecute.Parameters.Add(new SqlParameter("@CircularID", SqlDbType.NVarChar, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objDiscountMasterProperty.Description));
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'sp_SelectDistributor_TradeOffer' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("Discount Master::SelectAll::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_SelectDistributor_PrevTradeOffer]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("DISCOUNT_MASTER");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'sp_SelectDistributor_PrevTradeOffer' reported the ErrorCode: " + _errorCode);
                }
