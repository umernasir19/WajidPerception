...
{
    public class Vendor_Category_DAL : DBInteractionBase
    {
        private Vendor_Category_Property objVendorCategory;
        ...
        public override bool Insert()
        {
            ...
            cmdToExecute.CommandText = @"INSERT INTO [dbo].[Vendor_Category]
           ([vendorCategory]
           ...
           @CreatedByUserIdx
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@vendorCategory", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendorCategory.vendorCategory));
                //cmdToExecute.Parameters.Add(new SqlParameter("@HSCodeCat", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendorCategory.HSCodeCat));
                cmdToExecute.Parameters.Add(new SqlParameter("@createdByUserIdx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendorCategory.createdByUserIdx));
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'sp_insert_Vendor_category' reported the ErrorCode: " + _errorCode);
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Vendor_category::Insert::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"Update [dbo].[Vendor_Category] SET
...
where [idx]=@idx
           ...
           ";
            ...
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@vendorCategory", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendorCategory.vendorCategory));
                cmdToExecute.Parameters.Add(new SqlParameter("@lastModificationDate", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendorCategory.lastModificationDate));
                cmdToExecute.Parameters.Add(new SqlParameter("@lastModifiedByUserIdx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendorCategory.lastModifiedByUserIdx));
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objVendorCategory.idx));
                //cmdToExecute.Parameters.Add(new SqlParameter("@lastName", SqlDbType.NVarChar, 50, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.lastName));
                //cmdToExecute.Parameters.Add(new SqlParameter("@CNIC", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.CNIC));
                //cmdToExecute.Parameters.Add(new SqlParameter("@cellNumber", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.cellNumber));
                //cmdToExecute.Parameters.Add(new SqlParameter("@loginId", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.loginId));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select Concat(us.firstName,'',us.lastName) as userName,pc.* from Vendor_Category pc
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"update Vendor_Category SET visible=0 where idx=@idx";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
