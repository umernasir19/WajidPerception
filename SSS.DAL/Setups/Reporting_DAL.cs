...
{
    public class Reporting_DAL: DBInteractionBase
    {

        LP_Report_Property _objreport;
        public Reporting_DAL()
        {

        }

        public Reporting_DAL(LP_Report_Property objrport)
        {
            _objreport = objrport;
        }
        ...
        public DataTable SelectReportData()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_ReportData]";
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@id", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _objreport.ReportID));
                cmdToExecute.Parameters.Add(new SqlParameter("@from", SqlDbType.Date, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _objreport.FromDate));
                cmdToExecute.Parameters.Add(new SqlParameter("@to", SqlDbType.Date, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _objreport.ToDate));
