...
{
    public class itemUnit_DAL : DBInteractionBase
    {
        private itemUnit_Property objItemUnit;
        ...
        public override bool Insert()
        {
            ...
            cmdToExecute.CommandText = @"INSERT INTO [dbo].[itemUnits]
           ([itemUnit]
           ...
           @CreatedByUserIdx
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@itemUnit", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objItemUnit.itemUnit));
              
                cmdToExecute.Parameters.Add(new SqlParameter("@createdByUserIdx", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objItemUnit.createdByUserIdx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"Update [dbo].[itemUnits] SET
            [itemUnit] = @itemUnit
...
where [idx]=@idx
           ...
           ";
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@itemUnit", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objItemUnit.itemUnit));
                cmdToExecute.Parameters.Add(new SqlParameter("@lastModifiedByUserIdx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objItemUnit.lastModifiedByUserIdx));
                cmdToExecute.Parameters.Add(new SqlParameter("@lastModificationDate", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objItemUnit.lastModificationDate));
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objItemUnit.idx));
                //cmdToExecute.Parameters.Add(new SqlParameter("@lastName", SqlDbType.NVarChar, 50, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.lastName));
                //cmdToExecute.Parameters.Add(new SqlParameter("@CNIC", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.CNIC));
                //cmdToExecute.Parameters.Add(new SqlParameter("@cellNumber", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.cellNumber));
                //cmdToExecute.Parameters.Add(new SqlParameter("@loginId", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objUserProperty.loginId));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select Concat(us.firstName,'',us.lastName) as userName,pc.* from itemUnits pc
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"update itemUnits SET visible=0 where idx=@idx";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
