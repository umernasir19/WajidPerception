...
{
   public class CompanyCurrency_DAL : DBInteractionBase

    {
        currency_Property objCurrency;
        ...
        public override bool Insert()
        {
            ...
            cmdToExecute.CommandText = @"INSERT INTO [dbo].[companyCurrency]  
           ([currencyIdx]  
           ,[exhangeRate]  
           ,[createdByUserIdx]  
           ,[visble]  
     ...
     VALUES  
           (@currencyIdx,  
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@currencyIdx", SqlDbType.Int, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.currencyIdx));
                cmdToExecute.Parameters.Add(new SqlParameter("@exhangeRate", SqlDbType.Decimal, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.exhangeRate));

                cmdToExecute.Parameters.Add(new SqlParameter("@creationdate", SqlDbType.DateTime, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.creationDate));

                cmdToExecute.Parameters.Add(new SqlParameter("@visble", SqlDbType.Bit, 50, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.visble));

                cmdToExecute.Parameters.Add(new SqlParameter("@createdByUserIdx", SqlDbType.Int, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.createdByUserIdx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"select concat(us.firstName,'',us.lastName) as userName,cc.*,c.name,c.symbol,c.code

from companyCurrency cc 
left join currency c on cc.currencyidx = c.idx
left join users us on us.idx=cc.createdByUserIdx
where cc.visble=1";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"SELECT * FROM COMPANYCURRENCY WHERE idx=@idx";
           
            DataTable toReturn = new DataTable("ABC");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.idx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "UPDATE companyCurrency SET currencyIdx = @currencyIdx, exhangeRate = @exhangeRate, lastModifiedByUserIdx = @lastModifiedByUserIdx,lastModificationDate=@lastModificationDate  where  idx = @idx";
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@currencyIdx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.currencyIdx));

                cmdToExecute.Parameters.Add(new SqlParameter("@exhangeRate", SqlDbType.Decimal, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.exhangeRate));

                cmdToExecute.Parameters.Add(new SqlParameter("@lastModifiedByUserIdx", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.lastModifiedByUserIdx));
                cmdToExecute.Parameters.Add(new SqlParameter("@lastModificationDate", SqlDbType.NVarChar, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.lastModificationDate));
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 500, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.idx));
        ...
        public DataTable SelectAllCurrency()
        {
            ...
            try
            {
                //cmdToExecute.Parameters.Add(new SqlParameter("@id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.idx));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = @"update companyCurrency SET visble=0 where idx=@idx";
            //cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@idx", SqlDbType.Int, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objcompanyCurrencyProperty.idx));
