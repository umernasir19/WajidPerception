...
{
    public class DistributorWise_HistoryBlockedDiscount_DAL : DBInteractionBase
    {
        private DistributorWise_BlockedDiscountHistory_Property objDistributorWiseBlockedDiscountHistoryProperty;

        public DistributorWise_HistoryBlockedDiscount_DAL(DistributorWise_BlockedDiscountHistory_Property objDistributorWise_BlockedDiscountHistory_Property)
        {
        ...
        public override bool Insert()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_HistoryBlockedDiscount_Insert]";
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@DistributorWiseBlockedDiscountId", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.DistributorWiseBlockedDiscountId));
                cmdToExecute.Parameters.Add(new SqlParameter("@OperatedBy", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.Operated_By));
                cmdToExecute.Parameters.Add(new SqlParameter("@OperatedOn", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.OperatedOn));
                cmdToExecute.Parameters.Add(new SqlParameter("@Status", SqlDbType.NVarChar, 50, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@Id", SqlDbType.Int, 4, ParameterDirection.Output, false, 0, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.ID));
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'sp_HistoryBlockedDiscount_Insert' reported the ErrorCode: " + _errorCode);
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("HistoryBlockedDiscount:Insert::Error occured.", ex);
            }
            finally
            {
                if (_mainConnectionIsCreatedLocal)
        ...
        public bool UpdateStatus()
        {
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@tableName", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.TableName));
                cmdToExecute.Parameters.Add(new SqlParameter("@recordId", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@operation", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@operationBy", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objDistributorWiseBlockedDiscountHistoryProperty.Operated_By));
