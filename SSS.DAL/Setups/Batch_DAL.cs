...
{
    public class Batch_DAL : DBInteractionBase
    {
        private Batch_Setup_Property objBatchProperty;

        public Batch_DAL(Batch_Setup_Property objBatch_Setup_Property)
        {
            objBatchProperty = objBatch_Setup_Property;
        }
        /// <summary>
        ...
        public override bool Insert()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@Description", SqlDbType.VarChar, 200, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Description));
                cmdToExecute.Parameters.Add(new SqlParameter("@Active_Status", SqlDbType.VarChar, 1, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Active_Status));
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@Price_ID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed,objBatchProperty.Price_ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@Batch_Index", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed,objBatchProperty.Batch_Index));
                cmdToExecute.Parameters.Add(new SqlParameter("@Batch_Date", SqlDbType.DateTime, 8, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed,objBatchProperty.Batch_Date));
                cmdToExecute.Parameters.Add(new SqlParameter("@Expire_Date", SqlDbType.DateTime, 8, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed,objBatchProperty.Expire_Date));
                cmdToExecute.Parameters.Add(new SqlParameter("@Sale_Alert_Days", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed,objBatchProperty.Sale_Alert_Days));
                cmdToExecute.Parameters.Add(new SqlParameter("@Sale_Stop_Days", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed,objBatchProperty.Sale_Stop_Days));
                cmdToExecute.Parameters.Add(new SqlParameter("@Status", SqlDbType.VarChar,50, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, objBatchProperty.Status));


                cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed,objBatchProperty.ID));
                ...
                objBatchProperty.ID = (SqlInt32)cmdToExecute.Parameters["@iID"].Value;


                objBatchProperty.ErrorCode = (SqlInt32)cmdToExecute.Parameters["@iErrorCode"].Value;
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_BATCH_SETUP_Insert_New]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        public override DataTable SelectOne()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed,_errorCode));
                cmdToExecute.Parameters.Add(new SqlParameter("@Distrib", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objBatchProperty.Distributor_ID));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_GetBatch_ByProdcuctID]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("BATCH_SETUP");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
        ...
        public override DataTable SelectAll()
        {
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@Company_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Company_ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@Distributor_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objBatchProperty.Distributor_ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@Batch_Code", SqlDbType.VarChar, 20, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Batch_Code));
                cmdToExecute.Parameters.Add(new SqlParameter("@Description", SqlDbType.VarChar, 200, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objBatchProperty.Description));
                cmdToExecute.Parameters.Add(new SqlParameter("@Active_Status", SqlDbType.VarChar, 1, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objBatchProperty.Active_Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@Product_ID", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Product_ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@Price_ID", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Price_ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@Batch_Index", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Batch_Index));
                cmdToExecute.Parameters.Add(new SqlParameter("@Batch_Date", SqlDbType.DateTime, 10, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Batch_Date));
                cmdToExecute.Parameters.Add(new SqlParameter("@Expire_Date", SqlDbType.DateTime, 10, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Expire_Date));
                cmdToExecute.Parameters.Add(new SqlParameter("@Sale_Alert_Days", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Sale_Alert_Days));
                cmdToExecute.Parameters.Add(new SqlParameter("@Sale_Stop_Days", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Sale_Stop_Days));
                cmdToExecute.Parameters.Add(new SqlParameter("@Status", SqlDbType.NVarChar, 50, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@PageNum", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.PageNum ));
                cmdToExecute.Parameters.Add(new SqlParameter("@PageSize", SqlDbType.Int, 4, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.PageSize));
                cmdToExecute.Parameters.Add(new SqlParameter("@sortColumn", SqlDbType.VarChar, 12, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.SortColumn));
                cmdToExecute.Parameters.Add(new SqlParameter("@TotalRowsNum", SqlDbType.Int, 4, ParameterDirection.Output, true, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.TotalRowsNum));
        ...
        public bool UpdateStatus()
        {
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@tableName", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.TableName));
                cmdToExecute.Parameters.Add(new SqlParameter("@recordId", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.ID));
                cmdToExecute.Parameters.Add(new SqlParameter("@operation", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Status));
                cmdToExecute.Parameters.Add(new SqlParameter("@operationBy", SqlDbType.Int, 32, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objBatchProperty.Operated_By));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_GetTopBatch]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("BATCH_SETUP");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
