...
namespace SSS.DAL.Setups
{
    public class VendorProcess_DAL : DBInteractionBase
    {
        ...
        //        cmdToExecute.Parameters.Add(new SqlParameter("@creationDate", SqlDbType.Int, 500, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _objVendorProcessVmProperty.creationDate));
